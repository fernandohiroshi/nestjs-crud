...
describe('UsersController', () => {
  ...
  it('create - should call UsersService with the correct argument', async () => {
  ...
  it('findAll - should call UsersService', async () => {
    const expected = { anyKey: 'anyValue' };
  ...
  it('findOne - should call UsersService with the correct argument', async () => {
    const argument = '1';
    const expected = { anyKey: 'anyValue' };
  ...
  it('update - should call UsersService with the correct arguments', async () => {
    const argument1 = '1';
  ...
  it('remove - should call UsersService with the correct arguments', async () => {
    const argument1 = 1;
  ...
  it('uploadPicture - should call UsersService with the correct arguments', async () => {
